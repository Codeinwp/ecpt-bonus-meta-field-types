...
function ecpt_bonus_fields_scripts() {
	...
	wp_enqueue_script('ecpt-bonus-fields-scripts', ECPT_BF_URL . '/assets/js/bonus-fields.js');
}
...
function ecpt_bonus_fields_help_styles() {
	wp_enqueue_style('ecpt-admin', ECPT_BF_URL . 'includes/css/admin-styles.css');
}
